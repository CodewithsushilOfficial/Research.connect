    ...
    <div className="flex flex-col min-h-screen bg-bg-page text-text-primary">
      ...
      <div className="flex flex-grow relative">
        ...
        <button
          ...
          className="md:hidden fixed top-[69px] left-2 z-[45] w-10 h-10 flex items-center justify-center bg-blue-600 hover:bg-blue-700 text-white rounded-full shadow-lg active:scale-95 transition-all"
          title="Menu"
        >
