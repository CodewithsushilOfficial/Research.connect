...
const DatasetFinder = () => {
    ...
    try {
      await aiService.generateResponseStream({
        ...
        onDone: (session) => {
          ...
          loadUsageStats();
          setLoading(false);
          toast.success("Public datasets located!");
        },
        onError: (err) => {
          setLoading(false);
  ...
  const handleContinue = () => {
    const continuePrompt = "Provide instructions and snippets to access these datasets programmatically.";
  ...
  return (
    ...
    >
      <WorkspaceHeader
        ...
        description="Discover public repositories and open datasets."
        icon={Database}
