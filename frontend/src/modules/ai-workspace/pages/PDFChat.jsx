...
const PDFChat = () => {
  ...
  const handleContinue = () => {
    const continuePrompt = "Detail the core experimental validation results described in the PDF.";
  ...
  return (
    ...
    >
      <WorkspaceHeader
        title="AI PDF Chat"
        description="Upload research PDFs and converse directly with the paper."
        icon={FileText}
