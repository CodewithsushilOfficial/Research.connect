...
const ResearchGap = () => {
  ...
  const handleContinue = () => {
    const continuePrompt = "Outline a detailed research proposal aims layout to resolve the second gap.";
  ...
  return (
    ...
    >
      <WorkspaceHeader
        ...
        description="Analyze existing corpus to pinpoint unexplored avenues."
        icon={Brain}
      ...
      <PromptInput
        ...
        workspaceLabel="Research Gap Finder"
      />
