...
const MethodologyGenerator = () => {
    ...
    try {
      await aiService.generateResponseStream({
        ...
        onDone: (session) => {
          ...
          loadUsageStats();
          setLoading(false);
          toast.success("Methodology generated successfully!");
        },
        onError: (err) => {
          setLoading(false);
  ...
  const handleContinue = () => {
    const continuePrompt = "Detail the calibration phases and statistical assumptions required.";
  ...
  return (
    ...
    >
      <WorkspaceHeader
        ...
        description="Synthesize optimal experiment setups and validation metrics."
        icon={ClipboardList}
      ...
      <PromptInput
        ...
        workspaceLabel="Methodology Generator"
      />
