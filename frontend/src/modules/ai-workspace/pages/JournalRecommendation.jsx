...
const JournalRecommendation = () => {
    ...
    try {
      await aiService.generateResponseStream({
        ...
        onDone: (session) => {
          ...
          loadUsageStats();
          setLoading(false);
          toast.success("Journals recommended!");
        },
        onError: (err) => {
          setLoading(false);
  ...
  const handleContinue = () => {
    const continuePrompt = "Recommend journals that support fast-track editorial turnarounds of less than 4 weeks.";
  ...
  return (
    ...
    >
      <WorkspaceHeader
        title="AI Journal Recommendation"
        description="Match your manuscript abstract to optimal high-impact journals."
        icon={Compass}
        colorClass="text-lime-650"
      />
      ...
      <PromptInput
        ...
        workspaceLabel="Journal Recommendation"
      />
