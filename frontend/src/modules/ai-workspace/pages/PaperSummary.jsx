...
const PaperSummary = () => {
  ...
  const handleContinue = () => {
    const continuePrompt = "Detail the core contributions, datasets utilized, and findings of the research paper.";
  ...
  return (
    ...
    >
      <WorkspaceHeader
        ...
        description="Extract key insights, claims, and limitations instantly."
        icon={BookOpen}
