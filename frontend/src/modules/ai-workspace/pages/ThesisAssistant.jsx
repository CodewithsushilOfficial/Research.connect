...
const ThesisAssistant = () => {
    ...
    try {
      await aiService.generateResponseStream({
        ...
        onDone: (session) => {
          ...
          loadUsageStats();
          setLoading(false);
          toast.success("Draft segment compiled!");
        },
        onError: (err) => {
          setLoading(false);
  ...
  const handleContinue = () => {
    const continuePrompt = "Expand on the theoretical framework models related to attention interfaces.";
  ...
  return (
    ...
    >
      <WorkspaceHeader
        ...
        description="Co-pilot drafting chapters, literature gaps, and introductions."
        icon={FileText}
      ...
      <PromptInput
        ...
        workspaceLabel="Thesis Assistant"
      />
...
export default ThesisAssistant;
