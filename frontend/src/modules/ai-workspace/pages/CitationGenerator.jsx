...
const CitationGenerator = () => {
  ...
  const handleContinue = () => {
    const continuePrompt = "Provide additional formatted citations in Harvard and MLA styles.";
  ...
  return (
    ...
    >
      <WorkspaceHeader
        ...
        description="Generate correct formatted citations in APA, MLA, Harvard, BibTeX."
        icon={Quote}
      ...
      <PromptInput
        ...
        workspaceLabel="Citation Generator"
      />
