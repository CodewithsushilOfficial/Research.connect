...
const PublicationCard = ({ pub }) => {
  ...
  return (
    <motion.div 
      ...
      className="bg-white border border-slate-200 rounded-[18px] p-6 shadow-sm hover:shadow-md transition-all text-left"
    >
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex items-center gap-1 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-100/60 px-2.5 py-1 rounded-full">
      ...
      {/* Publication Metrics */}
      <div className="flex items-center gap-4 border-t border-b border-slate-100 py-3 mt-5 text-xs font-semibold text-slate-500">
