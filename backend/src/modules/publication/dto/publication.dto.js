class PublicationDTO {
  formatPublication(pub) {
    ...
    return {
      ...
      cloudinaryFileUrl: pubObj.document?.url || pubObj.cloudinaryFileUrl || pubObj.pdfURL || '',
      pdfURL: pubObj.document?.url || pubObj.pdfURL || pubObj.cloudinaryFileUrl || '',
      document: pubObj.document || null,
      attachments: pubObj.attachments || [],
      createdBy: pubObj.createdBy,
      lastUpdatedBy: pubObj.lastUpdatedBy,
      files: pubObj.files || [],
